...
def align_tensors(
    ...
    # Preserve committed core ownership. Reordering iteration symbols changes
    # neither an existing mapping expression nor its meaning. Only an explicit
    # factorization in remap may redistribute a source dimension's slice.
